        ...
        button_Update.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (isUpdate == true) {
                            Toast.makeText(EditOrderActivity.this, "Data Updated Successfully", Toast.LENGTH_LONG).show();
                        }
                        else{
                            Toast.makeText(EditOrderActivity.this, "Data Not Inserted", Toast.LENGTH_LONG).show();
                        }
                    }
                }
        );
        ...
        button_Delete.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(deletedRows > 0)
                            Toast.makeText(EditOrderActivity.this, "Data Deleted Successfully", Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(EditOrderActivity.this, "Data Not Deleted", Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
