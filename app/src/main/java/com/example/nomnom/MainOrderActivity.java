        ...
        btnAddData.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                      ...
                      if(isInserted = true)
                          Toast.makeText(MainOrderActivity.this,"Data Inserted Successfully",Toast.LENGTH_LONG).show();
                      else
                          Toast.makeText(MainOrderActivity.this,"Data Not Inserted",Toast.LENGTH_LONG).show();
